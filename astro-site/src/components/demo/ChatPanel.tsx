  ...
  return (
    <div className="demo-chat flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      <div ref={threadRef} className="flex-1 min-h-0 overflow-y-auto relative">
        {/* V logo watermark — shown when chat is empty */}
        {messages.length === 0 && toolCalls.length === 0 && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ bottom: '48px' }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="10.0000 4.1214 80.0000 69.8179" className="w-12 h-12" style={{ opacity: 0.1 }}>
